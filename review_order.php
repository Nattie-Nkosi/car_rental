  ...
  if ($count_cart == 0) {
    ...
    <div class="col-md-12">
      ...
      <div class="box text-center">
        ...
        <a href="shop.php" class="btn btn-primary btn-lg"> Return To Car Listing </a>
...
";
            ...
            <tr class="total">
              ...
              <?php if (count($physical_products) > 0) { ?>
                ...
                <th class="total-shipping-price">R<?php echo $total_cart_price; ?>.00</th>

              <?php } else { ?>

                <th class="total-shipping-price">R<?php echo $total; ?>.00</th>
                ...
                <?php if ($enable_paypal == "yes") { ?>
                  ...
                  <form id="paypal_form" action="<?php echo $paypal_url; ?>" method="post">
                    ...
                    <?php if (count($physical_products) > 0) { ?>
                      ...
                      <input type="hidden" name="return" value="http://localhost/fast_6/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total_cart_price; ?>">

                    <?php } else { ?>

                      <input type="hidden" name="return" value="http://localhost/fast_6/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total; ?>">

                    <?php } ?>

                    <input type="hidden" name="cancel_return" value="http://localhost/fast_6/checkout.php">
