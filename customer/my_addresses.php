...
<input type="submit" name="update_billing_address" value="Update Billing Address" class="form-control btn btn-success">
...
<input type="submit" name="update_shipping_address" value="Update Shipping Address" class="form-control btn btn-success">
