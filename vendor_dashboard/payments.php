...
Withdraw To <i class="fa fa-paypal"></i> Paypal Account 

</button>

<?php }else{ ?>

<button class="btn btn-success" onclick="return alert('You Must Have Minimum $<?php echo $minimum_withdraw_limit; ?> Available Balance To Withdraw Commissions To Your Paypal Account.');"> 
...
<h4 class="modal-title"> Withdraw Commissions To Paypal Account </h4>
...
For Withdraw Commissions To Your PayPal Account Please Add Your PayPal Account Email In
...
Your Commissions Will Be Sent To Follwing PayPal Account Email:
...
<input type="text" name="amount" class="form-control" min="<?php echo $minimum_withdraw_limit; ?>" max="<?php echo $current_balance; ?>" placeholder="<?php echo $minimum_withdraw_limit; ?> Minimum" required>
