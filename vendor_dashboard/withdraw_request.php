...
Current Balance: $1,024.70 <br><br>

Minimum Withdraw amount: $<?php echo $minimum_withdraw_limit; ?> <br><br>
...
<input type="submit" name="submit" value="Submit Withdraw Request" class="btn btn-primary form-control">
...
alert('New Withdraw Request Has Been Submited Successfully And Being Reviewed!.');
