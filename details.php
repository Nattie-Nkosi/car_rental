                ...
                <form action="" method="post" class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <?php if ($status == "product") { ?>
                      ...
                      <label class="col-lg-4 col-md-3 control-label">Car Quantity </label>
...
Product Price : <del> R$pro_price \ Day </del><br>

Product Sale Price : R$pro_psp_price \ Day
                      ...
                      if ($all_attributes_selected) {
                        ...
                        if ($status == "product") {
                          ...
                          if ($variation_product_psp_price == 0) {
                            ...
                            echo " Car Price : R$variation_product_price  \ Day";
                          } else {

                            echo "

Car Price : <del> R$variation_product_price \ Day </del><br>

Car Sale Price : R$variation_product_psp_price \ Day
...
";
                          ...
                          if ($variation_product_psp_price == 0) {
                            ...
                            echo " Bundle Price : R$variation_product_price \ Day ";
                          } else {

                            echo "

Bundle Price : <del> R$variation_product_price \ Day </del><br>

Bundle Sale Price : R$variation_product_psp_price \ Day
...
";
                  ...
                  <p class="text-center buttons">
                    ...
                    <a href="cart.php" class="btn btn-primary">
                      ...
                      <i class="fa fa-car"></i> View Booking List
                      ...
                      if (isset($_POST['add_cart'])) {
                        ...
                        if ($pro_type == "physical_product" or $pro_type == "digital_product") {
                          ...
                          if (mysqli_num_rows($run_cart) > 0) {
                            ...
                            echo "<script> alert('This Car is already added in Booking List'); </script>";
...
alert('This Combination Of Car Is Already Booking List, Please Choose A Different Combination.'); 
...
alert('This Combination Of Car Is Already Booked, Please Choose A Different Combination.'); 
          ...
          <div class="box" id="details">
            ...
            <div class="tab-content">
              ...
              <div id="vendor_info" class="tab-pane fade in">
                <!-- vendor_info tab-pane fade in Starts -->
                ...
                <div class="product-reviews" id="write-a-review">
                  ...
                  <section class="reviews-summary row">
                    ...
                    <article class="write-review col-md-4">
                      ...
                      <header> Have you Rented this Car before? </header>
                    ...
                    <ul id="all" class="reviews-list">
                      ...
                      <?php
                        ...
                        <li>
                          ...
                          <h3 align="center"> This Car Has No Reivew, Become First To Write A Reivew. </h3>
              ...
              <?php
                  ...
                  while ($row_products = mysqli_fetch_array($run_products)) {
                    ...
                    if ($product_type != "variable_product") {
                      ...
                      $product_price = "R$minimum_product_price - R$maximum_product_price \ Day";
...
";
                    ...
                    if (
                      ...
                      ($product_type != "variable_product" and $stock_status == "outofstock") or ($product_type == "variable_product" and $instock == 0)

                    ) {

                      $outofstock_label = " <div class='out-of-stock-label'>Not Available</div> ";
                    } else {
