...
<tr>
  ...
  <th colspan="2">
    ...
    <input id="offline" type="radio" name="payment_method" value="pay_offline" <?php if ($_SESSION["payment_method"] == "pay_offline") {
                                                                                  echo "checked";
                                                                                } ?>>
...
<?php if ($enable_stripe == "yes") { ?>
  ...
  <tr>
    ...
    <th colspan="2">
      ...
      <input id="stripe" type="radio" name="payment_method" value="stripe" <?php if ($_SESSION["payment_method"] == "stripe") {
                                                                                echo "checked";
                                                                              } ?>>
...
<?php if ($enable_paypal == "yes") { ?>
  ...
  <tr>
    ...
    <th colspan="2">
      ...
      <input id="paypal" type="radio" name="payment_method" value="paypal" <?php if ($_SESSION["payment_method"] == "paypal") {
                                                                                echo "checked";
                                                                              } ?>>
