<div class="box">
    ...
    <center>
        ...
        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
            ...
            <input type="hidden" name="business" value="nkosin361@gmail.com">
        ...
        <form action="stripe_charge.php" method="post">
            ...
            <input type="image" width="500" height="230" src="images/stripe.png" class="stripe-submit" data-name="Computerfever.com" data-description="Pay With Credit Card" data-image="images/stripe-logo.png" data-key="<?php echo $stripe['publishable_key']; ?>" data-amount="<?php echo $total; ?>" data-currency="usd" data-email="<?php echo $session_email; ?>">
