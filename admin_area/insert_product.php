      ...
      <div class="panel panel-default">
        ...
        <div class="panel-heading">
          ...
          <h3 class="panel-title">
            ...
            <i class="fa fa-money fa-fw"></i> Insert Car
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                ...
                <div class="form-group">
                  ...
                  <label> Car Seo Description </label>
                ...
                <div class="form-group">
                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                      ...
                      <a data-toggle="tab" href="#description"> Car Description </a>

                    </li>

                    <li>

                      <a data-toggle="tab" href="#features"> Car Features </a>
                ...
                <div class="form-group" id="product_weight">
                  ...
                  <label> Car Weight <small> (kg)</small> </label>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="product_type">
                    ...
                    <option value="physical_product"> (Simple Car) Simple Car </option>
...
$manufacturer_title
            ...
            <div class="form-group" id="product-stock-management">
              ...
              <label> Car Inventory Stock Management </label>
                    ...
                    <div class="col-sm-6" id="stock-status">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="stock_status" required>
                          ...
                          <option value="instock">Avalable</option>
