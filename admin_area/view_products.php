    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <h3 style="margin-top:0px;"> Filter Cars </h3>
          ...
          <form method="post" action="index.php?view_products=1">
            ...
            <div class="col-md-3 col-sm-6">
              ...
              <div class="form-group">
                ...
                <select name="stock_status" class="form-control">
                  ...
                  <option value="instock" <?php select_stock_status("instock"); ?>>Available</option>

                  <option value="outofstock" <?php select_stock_status("outofstock"); ?>>Not Available</option>
            ...
            <div class="col-md-3 col-sm-6">
              ...
              <button type="submit" class="btn btn-success form-control"> Filter Cars </button>
...
";
                  ...
                  <tr>
                    ...
                    <td colspan="8" class="text-center">
                      ...
                      <h3> Sorry, We Have Not Found Any Cars. </h3>
                    ...
                    <td>
                      ...
                      <?php
                          ...
                          if ($pro_type != "variable_product") {
                            ...
                            echo $product_price = "R$minimum_product_price <br>---<br> R$maximum_product_price";
                          }
                          ...
                          <?php if ($pro_vendor_status == "pending") { ?>
                            ...
                            <li>
                              ...
                              <a href="index.php?approve_product=<?php echo $pro_id; ?>&products">
                                ...
                                <i class="fa fa-pause-circle-o"></i> Approve Cars
                          ...
                          <?php } elseif ($pro_vendor_status == "trash") { ?>
                            ...
                            <li>
                              ...
                              <a href="index.php?restore_product=<?php echo $pro_id; ?>&products">
                                ...
                                <i class="fa fa-eye"></i> Restore Car
