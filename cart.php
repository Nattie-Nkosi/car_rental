  ...
  <div id="top">
    ...
    <div class="container">
      ...
      <div class="col-md-6 offer">
        ...
        <!-- <a href="#">
          Rental Total Price: <span class="subtotal-cart-price"><?php total_price(); ?></span>, Total Vehicles <?php items(); ?>
        </a> -->
    ...
    <div class="container-fluid">
      ...
      <div class="col-md-12">
        ...
        <nav class="checkout-breadcrumbs text-center">
          ...
          <a href="cart.php" class="active">Car Listing</a>
      ...
      <div class="col-md-9" id="cart">
        ...
        <div class="box">
          ...
          <form action="cart.php" method="post" enctype="multipart-form-data">
            ...
            <p class="text-muted"> You currently have <?php items(); ?> Vehicle(s) in your booking. </p>
...
<p style="margin-top:8px;"> <strong> Vendor : </strong> <?php echo $vendor_name; ?> </p>
                ...
                <tfoot>
                  ...
                  <tr>
                    ...
                    <th colspan="2"> <span class="subtotal-cart-price">R<?php echo $total; ?></span>.00 </th>
        ...
        <div id="row same-height-row">
          ...
          <div class="col-md-3 col-sm-6">
            ...
            <div class="box same-height headline">
              ...
              <h3 class="text-center"> You also like these Cars </h3>
                ...
                <?php if (count($physical_products) > 0) { ?>
                  ...
                  <tr>
                    ...
                    <th colspan="2">
                      ...
                      <p class="shipping-header text-muted"> Total Weight: <?php echo array_sum($total_weight); ?> Kg </p>
...
";
                                    ...
                                    <li>
                                      ...
                                      <span class="shipping-type-name">
                                        ...
                                        <?php echo $type_name; ?>: <span class="text-muted"> R<?php echo $shipping_cost; ?> </span>
...
";
                ...
                <tr class="total">
                  ...
                  <?php if (count($physical_products) > 0) { ?>
                    ...
                    <th class="total-cart-price">R<?php echo $total_cart_price; ?>.00</th>

                  <?php } else { ?>

                    <th class="total-cart-price">R<?php echo $total; ?>.00</th>
